...
$Usuarioadmin = [
    'user_name' => "Admin",
    'user_email' => "admin@logar.com",
    'user_pass' => '$2y$11$ac961d1cc343d6c66c486eeKwLzpKCseoK4.Mqjgi0.PFGFR5tECa', //logar123
    'user_cpf' => "111.444.777-35",
    'user_rg' => "11.444.777-x",
    'user_level' => 100
];
...
$DB->QRInsert( 'users', $Usuarioadmin );
echo ($DB->getResult()) ? 'Usuário "Admin" criada com sucesso!<br/>' : 'nao foi possivel criar o uruário "Admin"<br/>';
